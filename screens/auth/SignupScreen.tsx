    ...
    <View className="flex-1 bg-indigo-600">
      <SafeAreaView className="flex-1">
        ...
        <View className="px-6 pt-6 pb-8">
          ...
          <Text className="text-white text-base mt-2 opacity-80">Sign up to get started</Text>
        </View>
        ...
        <View className="flex-1 bg-white rounded-t-[30px] px-6 pt-8">
          ...
          >
            <ScrollView showsVerticalScrollIndicator={false}>
              {/* Form Fields */}
              <View className="mb-6">
                <Text className="text-gray-700 text-base mb-2 font-medium">Full Name</Text>
                <View className="flex-row items-center border border-gray-300 rounded-xl px-4 py-3">
                  <Ionicons name="person-outline" size={20} color="#6366f1" className="mr-2" />
                  <TextInput
              ...
              <View className="flex-row items-center mb-8">
                ...
                <Text className="text-gray-500 ml-2 flex-1">
                  I agree to the <Text className="text-indigo-600 font-medium">Terms & Conditions</Text> and <Text className="text-indigo-600 font-medium">Privacy Policy</Text>
                </Text>
              </View>
